...
use App\Http\Resources\Admin\FileManager\FileManagerCollection;
...
class FileManagerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $datas = FileManager::orderBy('created_at', 'desc')->select('id','file','type','name','original_name','size');
            ...
            return response()->json(new FileManagerCollection($datas));
           
        }
        return view('admin.file-manager.list');
    }
