                    ...
                    <div class="card-body">
                        <table id="datatable" class="datatable table table-bordered nowrap align-middle" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th>Email</th>
                                <th>Mobile No.</th>
                                <?php if (\Illuminate\Support\Facades\Blade::check('can', ['edit_company','delete_company', 'read_company'])): ?>
                                  <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
        ...
        // { "data": "status" },
        {
            ...
            render: function(data, type, row) {
                if (type === 'display') {
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('can', 'edit_company')): ?>
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('can', 'delete_company')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\New folder\payrolloriginal\resources\views/admin/company/list.blade.php ENDPATH**/ ?>