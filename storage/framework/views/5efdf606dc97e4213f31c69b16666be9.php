                ...
                <table id="datatable" class="datatable table table-bordered nowrap align-middle" style="width:100%">
                    <thead class="gridjs-thead">
                        <tr>
                            ...
                            <th>Service Name</th>
                            <th>Status</th>
                            <?php if (\Illuminate\Support\Facades\Blade::check('can', ['edit_services', 'delete_services'])): ?>
                                <th>Action</th>
                            <?php endif; ?>
                        </tr>
                    </thead>
      ...
      
        {
            ...
            render: function(data, type, row) {
                if (type === 'display') {
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('can', ['edit_services','delete_services', 'read_services'])): ?>

                    <?php if (\Illuminate\Support\Facades\Blade::check('can', 'edit_services')): ?>
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('can', 'delete_services')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\New folder\payrolloriginal\resources\views/admin/services/list.blade.php ENDPATH**/ ?>