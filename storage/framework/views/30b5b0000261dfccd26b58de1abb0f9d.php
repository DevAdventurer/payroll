...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <?php echo e(html()->text('udyam_no')->class('form-control')->placeholder('Enter your 19 digit Udyam Registration number')->value(old('udyam_no'))); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <?php echo e(html()->text('cin_no')->class('form-control')->placeholder('Enter your 21 digitCIN No.')->value(old('cin_no'))); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <?php echo e(html()->text('epf_no')->class('form-control')->placeholder('Enter ypur 15 digit EPF No.')->value(old('epf_no'))); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <?php echo e(html()->text('esic_no')->class('form-control')->placeholder('Enter ypur 17 digit ESIC No.')->value(old('esic_no'))); ?>
