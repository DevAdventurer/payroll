                    ...
                    <div class="card-body">
                        <table id="datatable" class="datatable table table-bordered nowrap align-middle" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th>Wages</th>
                                <th>Status</th>
                                <?php if (\Illuminate\Support\Facades\Blade::check('can', ['edit_minimum_wages','delete_minimum_wages', 'read_minimum_wages'])): ?>
                                  <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
        ...
        // { "data": "status" },
        {
            ...
            render: function(data, type, row) {
                if (type === 'display') {
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('can', 'edit_minimum_wages')): ?>
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('can', 'delete_minimum_wages')): ?>
