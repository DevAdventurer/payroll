...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3 form-group">
                                            <?php echo e(html()->label('Fees')->for('fee_amount')); ?>

                                            <?php echo e(html()->number('fee_amount')->class('form-control')->required()->placeholder('Enter fee amount')->value(old('fee_amount'))); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3 form-group">
                                            <?php echo e(html()->label('DOC NO')->for('doc_no')); ?>

                                            <?php echo e(html()->text('doc_no')->class('form-control')->required()->placeholder('Enter Doc Number')->value(old('doc_no'))); ?>

                                            <?php $__errorArgs = ['doc_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3 form-group">
                                            <?php echo e(html()->label('Month')->for('month')); ?>

                                            <?php echo e(html()->select('month', [
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\New folder\payrolloriginal\resources\views/admin/Fees/create.blade.php ENDPATH**/ ?>