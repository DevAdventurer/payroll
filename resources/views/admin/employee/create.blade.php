    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group{{ $errors->has('company') ? ' has-error' : '' }}">
                        ...
                        {{ html()->select('company', $companies)->class('form-control')->id('company')->placeholder('Choose Company') }}
                    ...
                    <div class="form-group{{ $errors->has('role') ? ' has-error' : '' }}">
                        ...
                        {{ html()->select('role', $roles)->class('form-control')->id('role')->placeholder('Choose Role') }}
            ...
            <div class="mt-4 form-group">
                {{ html()->button('Save Employee Details')->type('button')->class('btn btn-success bg-gradient')->attribute('onclick = store(this)') }}
            </div>
        </div>
    </div>
    {{ html()->form()->close() }}
