...
@section('main')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                @can(['browse_client', 'add_client', 'read'])
                    ...
                    <div class="page-title-right btn-group" role="group">
                        ...
                        <div class="p-0 dropdown-menu" aria-labelledby="clientGroup" data-popper-placement="bottom-start" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(0px, 39.5px, 0px);">
                            ...
                            <div class="m-0 dropdown-divider"></div>
                            @can('edit_client')
                                <a class="dropdown-item" href="{{ route('admin.' . request()->segment(2) . '.show', $client->id) }}">View This {{ Str::title(str_replace('-', ' ', request()->segment(2))) }}</a>
                            @endcan
                        </div>
                    </div>
                @endcan
    ...
    {{ html()->form('PUT', route('admin.' . request()->segment(2) . '.update', $client->id))->attribute('enctype', 'multipart/form-data')->id('store')->open() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                ...
                                {{ html()->text('first_name', $client->first_name)->class('form-control')->placeholder('First Name') }}
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                ...
                                {{ html()->text('last_name', $client->last_name)->class('form-control')->placeholder('Last Name') }}
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group{{ $errors->has('mobile_number') ? ' has-error' : '' }}">
                                ...
                                {{ html()->text('mobile_number', $client->mobile)->class('form-control')->id('mobile_no')->placeholder('Mobile Number') }}
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                                ...
                                {{ html()->select('state', $states, $client->state_id)->class('form-control states')->placeholder('Choose State') }}
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group{{ $errors->has('district') ? ' has-error' : '' }}">
                                ...
                                {{ html()->select('district', App\Models\District::where('state_id', $client->state_id)->pluck('name', 'id'), $client->district_id)->class('form-control getDistrict')->placeholder('Choose district') }}
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                ...
                                {{ html()->select('city', App\Models\City::where('district_id', $client->district_id)->pluck('name', 'id'), $client->city_id)->class('form-control getCity')->placeholder('Choose City') }}
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group{{ $errors->has('locality') ? ' has-error' : '' }}">
                                ...
                                {{ html()->text('locality', $client->locality)->class('form-control')->placeholder('Locality') }}
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                {{ html()->textarea('address', $client->address)->class('form-control', $client->address)->placeholder('Address (Area and Street)')->rows(1) }}
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group{{ $errors->has('landmark') ? ' has-error' : '' }}">
                                ...
                                {{ html()->text('landmark', $client->landmark)->class('form-control')->placeholder('Landmark') }}
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                            ...
                            {{ html()->select('status', App\Models\Status::whereIn('id', [12, 15])->pluck('name', 'id'), $client->status_id)->class('form-control')->id('status')->placeholder('Status') }}
                    ...
                    <div class="form-group">
                        <div class="mt-4 media-area form-control onFocus" file-name="logo">
                            <div class="media-file-value">
                                @if ($client->media)
                                    <input type="hidden" name="logo[]" value="{{ $client->media_id }}"
                                        class="fileid{{ $client->media_id }}">
                                @endif
                            </div>
                            <div class="media-file">
                                @if ($client->media)
                                    <div class="file-container d-inline-block fileid{{ $client->media_id }}">
                                        ...
                                        <img class="w-100 d-block img-thumbnail" src="{{ asset($client->media->file) }}"
                                            alt="{{ $client->media->name }}">
                                    </div>
                                @endif
                            </div>
